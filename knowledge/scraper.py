...
SOURCES = {
    ...
    "tools": [
        {"name": "Kali_Tools_Docs", "url": "https://www.kali.org/tools/", "type": "text"},
        {"name": "Metasploit_Unleashed", "url": "https://raw.githubusercontent.com/rapid7/metasploit-framework/master/README.md", "type": "text"},
        {"name": "Metasploit_Docs", "url": "https://docs.metasploit.com/docs/using-metasploit/getting-started/nightly-installers.html", "type": "text"},
        {"name": "Nmap_Reference", "url": "https://raw.githubusercontent.com/nmap/nmap/master/docs/nmap.usage.txt", "type": "text"},
        {"name": "Wireshark_Docs", "url": "https://www.wireshark.org/docs/wsug_html_chunked/", "type": "text"},
        {"name": "Burp_Suite_Docs", "url": "https://portswigger.net/burp/documentation/desktop/getting-started", "type": "text"},
        {"name": "PortSwigger_Web_Security", "url": "https://portswigger.net/web-security/all-topics", "type": "text"},
        ...
        {"name": "PortSwigger_CSRF", "url": "https://portswigger.net/web-security/csrf", "type": "text"},
        {"name": "PortSwigger_SSRF", "url": "https://portswigger.net/web-security/ssrf", "type": "text"},
        {"name": "Linux_Man_Pages_Bash", "url": "https://www.gnu.org/software/bash/manual/bash.html", "type": "text"},
        {"name": "Linux_Command_Reference", "url": "https://raw.githubusercontent.com/nicowillis/linux-commands/main/README.md", "type": "text"},
        ...
        {"name": "PWNDBG_Docs", "url": "https://raw.githubusercontent.com/pwndbg/pwndbg/dev/README.md", "type": "text"},
        ...
        {"name": "John_The_Ripper_Docs", "url": "https://raw.githubusercontent.com/openwall/john/bleeding-jumbo/doc/README", "type": "text"},
        ...
        {"name": "Tmux_Cheatsheet", "url": "https://raw.githubusercontent.com/tmuxinator/tmuxinator/master/README.md", "type": "text"},
        {"name": "Vim_Reference", "url": "https://raw.githubusercontent.com/vim/vim/master/README.md", "type": "text"},
        {"name": "Python_Security_Libs", "url": "https://raw.githubusercontent.com/paramiko/paramiko/main/README.rst", "type": "text"},
        ...
        {"name": "ArXiv_Pentesting", "url": "https://export.arxiv.org/api/query?search_query=penetration+testing+automation+tools&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_Exploit_Dev", "url": "https://export.arxiv.org/api/query?search_query=exploit+development+buffer+overflow+shellcode&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_Wireless_Security", "url": "https://export.arxiv.org/api/query?search_query=wireless+network+security+attack+wifi&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "OWASP_WSTG_Full", "url": "https://raw.githubusercontent.com/OWASP/wstg/master/document/README.md", "type": "text"},
    ...
    "technology": [
        {"name": "Apple_M_Series_Specs", "url": "https://www.apple.com/mac/compare/", "type": "text"},
        {"name": "CVE_iPhone_Security", "url": "https://export.arxiv.org/api/query?search_query=iOS+iPhone+security+vulnerability+exploit&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "CVE_Android_Security", "url": "https://export.arxiv.org/api/query?search_query=Android+mobile+security+vulnerability+exploit&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_IoT_Security", "url": "https://export.arxiv.org/api/query?search_query=IoT+internet+of+things+security+vulnerability&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_Router_Security", "url": "https://export.arxiv.org/api/query?search_query=router+network+device+security+firmware+vulnerability&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_Firmware_Security", "url": "https://export.arxiv.org/api/query?search_query=firmware+analysis+embedded+systems+security&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_Hardware_Security", "url": "https://export.arxiv.org/api/query?search_query=hardware+security+side+channel+attack+CPU&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_Spectre_Meltdown", "url": "https://export.arxiv.org/api/query?search_query=spectre+meltdown+CPU+microarchitecture+attack&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_BIOS_UEFI", "url": "https://export.arxiv.org/api/query?search_query=BIOS+UEFI+bootkit+firmware+security&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_Cloud_Security", "url": "https://export.arxiv.org/api/query?search_query=cloud+security+AWS+Azure+GCP+misconfiguration&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_Container_Security", "url": "https://export.arxiv.org/api/query?search_query=Docker+Kubernetes+container+security+escape&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_5G_Security", "url": "https://export.arxiv.org/api/query?search_query=5G+network+security+vulnerability+protocol&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_Bluetooth_Security", "url": "https://export.arxiv.org/api/query?search_query=Bluetooth+BLE+security+attack+vulnerability&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_USB_Security", "url": "https://export.arxiv.org/api/query?search_query=USB+BadUSB+HID+attack+security&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_Laptop_Security", "url": "https://export.arxiv.org/api/query?search_query=laptop+endpoint+security+attack+defense&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_Windows_Security", "url": "https://export.arxiv.org/api/query?search_query=Windows+Active+Directory+security+attack&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_Linux_Security", "url": "https://export.arxiv.org/api/query?search_query=Linux+kernel+security+privilege+escalation&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_macOS_Security", "url": "https://export.arxiv.org/api/query?search_query=macOS+Apple+silicon+security+vulnerability&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_Network_Protocol", "url": "https://export.arxiv.org/api/query?search_query=TCP+IP+network+protocol+attack+security&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_SCADA_ICS", "url": "https://export.arxiv.org/api/query?search_query=SCADA+ICS+industrial+control+system+security&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_GPU_Security", "url": "https://export.arxiv.org/api/query?search_query=GPU+graphics+processor+security+side+channel&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_Memory_Security", "url": "https://export.arxiv.org/api/query?search_query=memory+safety+heap+stack+exploitation+defense&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "NIST_Device_Guidelines", "url": "https://raw.githubusercontent.com/usnistgov/NIST-SP-800-155/main/README.md", "type": "text"},
        {"name": "ArXiv_AI_Chip_Security", "url": "https://export.arxiv.org/api/query?search_query=AI+chip+NPU+machine+learning+hardware+security&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_iOS_Security", "url": "https://export.arxiv.org/api/query?search_query=iOS+Apple+iPhone+security+vulnerability+jailbreak&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_Android_Security", "url": "https://export.arxiv.org/api/query?search_query=Android+Google+mobile+OS+security+malware+exploit&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_Ubuntu_Linux_Security", "url": "https://export.arxiv.org/api/query?search_query=Ubuntu+Linux+kernel+security+CVE+privilege+escalation&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_Windows_OS_Security", "url": "https://export.arxiv.org/api/query?search_query=Windows+OS+kernel+security+exploit+patch+tuesday&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_macOS_Ventura_Sonoma", "url": "https://export.arxiv.org/api/query?search_query=macOS+Ventura+Sonoma+security+vulnerability+exploit&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_ChromeOS_Security", "url": "https://export.arxiv.org/api/query?search_query=ChromeOS+Chrome+browser+security+sandbox+escape&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_Hypervisor_Security", "url": "https://export.arxiv.org/api/query?search_query=hypervisor+VMware+KVM+security+VM+escape&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "ArXiv_Smartphone_Forensics", "url": "https://export.arxiv.org/api/query?search_query=smartphone+mobile+forensics+data+extraction+security&max_results=50&sortBy=submittedDate", "type": "arxiv"},
        {"name": "NIST_Mobile_Security", "url": "https://raw.githubusercontent.com/usnistgov/mobile-threat-catalogue/master/README.md", "type": "text"},
        {"name": "ArXiv_OS_Kernel_Security", "url": "https://export.arxiv.org/api/query?search_query=operating+system+kernel+security+attack+defense&max_results=50&sortBy=submittedDate", "type": "arxiv"},
    ],
    "spiritual": [
